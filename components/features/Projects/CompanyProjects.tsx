  ...
  return (
    <section className="w-full flex flex-col gap-y-5">
      ...
      <div className="flex gap-x-5">
        <div
          className="flex-[0_0_35%] min-w-0 aspect-[320/904] bg-cover bg-center rounded-[20px] sm:rounded-[28px] md:rounded-[32px] lg:rounded-[40px] bg-no-repeat"
      ...
      <div className="flex flex-row-reverse gap-x-5">
        <div
          className="flex-[0_0_35%] min-w-0 aspect-[320/596] bg-cover bg-center rounded-[20px] sm:rounded-[28px] md:rounded-[32px] lg:rounded-[40px] bg-no-repeat"
