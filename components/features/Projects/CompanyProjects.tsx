    ...
    <section className="w-full flex flex-col gap-y-5">
      ...
      <div className="flex gap-x-5">
        <div
          ...
          className={cn(
            "flex-[0_0_35%] min-w-0 aspect-[320/904] bg-cover bg-center rounded-[20px] sm:rounded-[28px] md:rounded-[32px] lg:rounded-[40px] bg-no-repeat scroll-animate-slide-right",
      ...
      <div className="flex flex-row-reverse gap-x-5">
        <div
          ...
          className={cn(
            "flex-[0_0_35%] min-w-0 aspect-[320/596] bg-cover bg-center rounded-[20px] sm:rounded-[28px] md:rounded-[32px] lg:rounded-[40px] bg-no-repeat scroll-animate-slide-left",
